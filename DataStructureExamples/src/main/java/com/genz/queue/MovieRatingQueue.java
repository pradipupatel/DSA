...
class MovieRatingQueue {
	public static void main(String[] args) {
		...
		// Here are the movies and their ratings in the correct order, e.g. Gangs of
		// Wasseypur has a rating 5 and so on.
		...
		for (int i = 0; i < 4; i++) {
			...
			while (!movieQueue.peek().getTitle().equalsIgnoreCase(title)) {
